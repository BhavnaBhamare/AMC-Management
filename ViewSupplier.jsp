...
<%
   ...
   List<Managesupplier> ms=bl.searchSuplierList();
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">Suplier Details</div>
					...
					<table data-toggle="table" data-url="tables/data1.json"
						...
						<thead>
							<tr>
								...
								<th data-field="id1" data-sortable="true">Suplier ID</th>
								<th data-field="id2" data-sortable="true">Suplier Name</th>
								<th data-field="id3" data-sortable="true">Suplier Address</th>
								<th data-field="id4" data-sortable="true">Suplier Contact</th>
