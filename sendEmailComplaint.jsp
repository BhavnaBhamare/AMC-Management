					...
					<table data-toggle="table" data-url="tables/data1.json"
						...
						<thead>
							<tr>
								...
								<th data-field="id6" data-sortable="true">Mail</th>
								<th data-field="id7" data-sortable="true">Send Mail</th>
						...
						<c:forEach items="${sessionScope.list1}" var="l">
							<tr>
								...
								<td data-field="id8" data-sortable="true"><c:out
										value="${l.customer.cname} " /></td>
								<td data-field="id2" data-sortable="true"><c:out
										value="${l.employee.fname} " /></td>
								...
								<td data-field="id5" data-sortable="true"><c:out
										value="${l.statusdate} " /></td>
								<td data-field="id6" data-sortable="true"><c:out
										value="${l.customer.email} " /></td>
								<td data-field="id7" data-sortable="true"><a
									href="SendMailController?comid=${l.comid}"
									style="color: #30a5ff;">Send Mail</a></td>
